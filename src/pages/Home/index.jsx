...
function Home(){
  ...
  return (
    <div className={`lg:flex justify-center mx-2`}>
      <div className={`flex flex-col-reverse lg:flex-row p-6 lg:w-full lg:max-w-10/12 lg:py-10 lg:px-30 mt-10 items-center justify-between rounded-xl ${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-50'} justify-between`}>
