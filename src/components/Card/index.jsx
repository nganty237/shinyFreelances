...
function Card({ label, title, picture }) {
    ...
    return (
        <div className={`flex flex-col space-y-4 ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-100'} shadow-sm w-full max-w-xs lg:max-w-md transition duration-300 rounded-md hover:cursor-pointer p-4 lg:p-6 items-center justify-center`}>
